...
window.HOLE13_NARRATIVE = {
  ...
  fema: "The map at right is the FEMA flood-hazard map for the Hole 13 corridor. The red-hatched zone is the regulatory floodway, the channel reserved for the active flow of floodwaters during a major event. The blue zone is the Special Flood Hazard Area, with a one-percent annual chance of flooding (the 100-year floodplain); the tan zone carries a 0.2-percent annual chance (the 500-year floodplain). Together, the three zones cover nearly the entire hole. The base flood elevations marked along the corridor, ranging from 27.0 feet at the green to 29.0 feet near the back of the fairway, are the elevations to which the brook is expected to rise in a 100-year event. Existing playing surfaces sit at or below these elevations through much of the corridor.",
  ...
  elevations: ["28.0'", "28.4'", "28.6'", "29.0'", "27.0'", "27.0'"]
};
